function [entryRecord,exitRecord,my_currentcontracts,obj,vararg] = for_MESM5( strategy,bardata,pro_information,ConOpenTimes,isMoveOn,trainBeg,trainEnd,strategyArg,varargin )
    ...
    for E=strategyArg{2}
        for StopLossRate=strategyArg{3}
            ...
            [entryRecord,exitRecord,my_currentcontracts] = ...
                train_MESM5(trainData,pro_information,M,E,StopLossRate,ConOpenTimes);
