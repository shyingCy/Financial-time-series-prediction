function [entryRecord,exitRecord,my_currentcontracts,obj,vararg] = for_MES( strategy,bardata,pro_information,ConOpenTimes,isMoveOn,trainBeg,trainEnd,strategyArg,varargin )
    ...
    for E=strategyArg{2}
        for StopLossRate=strategyArg{3}
            ...
            [entryRecord,exitRecord,my_currentcontracts] = ...
                train_MES(trainData,pro_information,M,E,StopLossRate,ConOpenTimes);
