function [LongMargin,ShortMargin,StaticEquity,DynamicEquity,Cash] = train_compAssertsVar(Marketposition,Close,StaticEquity,entryprice,myOpenIntRecord,profit,TradingUnits,MarginRatio)
